...
<div className='text-center'>
<FaSquarePhoneFlip className='text-5xl mx-auto mb-4 text-[#2980b9]' />
<h4 className='text-2xl font-semibold mb-4'>Telephone No.</h4>
<p>Phone 1: 0(1234) 567 89012 <br />
Phone 2: 0(987) 567 890</p>
</div>
<div className='text-center'>
<FaLocationDot className='text-5xl mx-auto mb-4 text-[#2980b9]'  />
...
<div className='text-center'>
<BsFillPhoneFill className='text-5xl mx-auto mb-4 text-[#2980b9]' />
<h4 className='text-2xl font-semibold mb-4'>Phone Number</h4>
<p>Phone 1: 0(1234) 567 89012<br />
Phone 2: 0(987) 567 890</p>
</div>
<div className='text-center'>
<MdEmail className='text-5xl mx-auto mb-4 text-[#2980b9]'/>
